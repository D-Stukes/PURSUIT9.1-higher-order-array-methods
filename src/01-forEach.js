...
function printAllSongTitles(songs) {
  let listOfTitles = exampleSongData.forEach( (song) => console.log(song.title)  )
}
...
function printSongDetails(songs) {
  let listOfTitlesAndArtists = exampleSongData.forEach( (song) => {
...
function printSongTitlesOverThreeMinutes(songs) {
  let allSongsOver3Mins = exampleSongData.forEach( (song) => {
